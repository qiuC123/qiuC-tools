...
- 固定发布页：`https://github.com/qiuC123/qiuC-tools/releases/tag/wechat-oa-v0.7.3`
- Windows x64 ZIP：`https://github.com/qiuC123/qiuC-tools/releases/download/wechat-oa-v0.7.3/wechat-oa-0.7.3-windows-x64.zip`
- SHA-256 文件：`https://github.com/qiuC123/qiuC-tools/releases/download/wechat-oa-v0.7.3/wechat-oa-0.7.3-windows-x64.zip.sha256`
- 固定 SHA-256：`be6c85c404f431af654ca6f1da7d07e622e9ea9a66947811315043a3c2b8daaf`
...
$releaseTemp = Join-Path ([System.IO.Path]::GetTempPath()) `
  ("wechat-oa-0.7.3-" + [guid]::NewGuid().ToString("N"))
New-Item -ItemType Directory -Path $releaseTemp | Out-Null
$releaseZip = Join-Path $releaseTemp "wechat-oa-0.7.3-windows-x64.zip"
$releaseHash = "$releaseZip.sha256"
Invoke-WebRequest `
  "https://github.com/qiuC123/qiuC-tools/releases/download/wechat-oa-v0.7.3/wechat-oa-0.7.3-windows-x64.zip" `
  -OutFile $releaseZip
Invoke-WebRequest `
  "https://github.com/qiuC123/qiuC-tools/releases/download/wechat-oa-v0.7.3/wechat-oa-0.7.3-windows-x64.zip.sha256" `
  -OutFile $releaseHash
...
$pinnedHash = "be6c85c404f431af654ca6f1da7d07e622e9ea9a66947811315043a3c2b8daaf"
...
$releaseExe = Join-Path $releaseTemp `
  "wechat-oa-0.7.3-windows-x64\wechat-oa.exe"
& $releaseExe --version
& $releaseExe --json doctor
```

必须同时看到版本 `0.7.3`、进程退出码 `0` 和 Doctor JSON 的 `ok: true` 才算临时
